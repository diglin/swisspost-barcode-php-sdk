...
class SingleBarcodesResponseDefinition extends SingleBarcodesDefinition
{
    ...
    /**
     * Constructor method for SingleBarcodesResponseDefinition
     * @uses SingleBarcodesResponseDefinition::setColorPrintRequired()
     ...
     * @param bool $colorPrintRequired
     * @return \Diglin\Swisspost\StructType\SingleBarcodesResponseDefinition
     */
